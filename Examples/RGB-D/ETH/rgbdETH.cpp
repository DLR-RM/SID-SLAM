...
namespace IDNav{
    ...
    //void statisticVisualizerRun(const std::shared_ptr<IDNav::StatisticVisualizer> &  statisticVisualizer);
    //void mapVisualizerRun(const std::shared_ptr<IDNav::MapVisualizer> & mapVisualizer);
...
int main(int argc, char** argv) {
    ...
    // Read inputs
    std::cout << BOLDMAGENTA_COUT <<  "\nInitialize SID_SLAM in ETH sequence ..." << RESET_COUT << std::endl;
    ...
    std::string datasetFolder = "~/datasets/ETH/training";
    ...
    else resultsFolder = "../../../results/RGB-D/ETH/" + sidSlam.seqSet.sequenceName ;
    ...
    std::cout << BOLDMAGENTA_COUT <<  "\nRun SID_SLAM in RGBD-ETH sequence ..." << RESET_COUT << std::endl;
    ...
    if(sidSlam.sysSet.visualization){
        std::thread statisticVisualizerLoop(IDNav::statisticVisualizerRun,sidSlam.visualizer->statisticVisualizer);
        std::thread mapVisualizerLoop(IDNav::mapVisualizerRun,sidSlam.visualizer->mapVisualizer);
...
/*
void IDNav::statisticVisualizerRun(const std::shared_ptr<IDNav::StatisticVisualizer> & statisticVisualizer){
...
void IDNav::mapVisualizerRun(const std::shared_ptr<IDNav::MapVisualizer> &  mapVisualizer){
